...
\positionmul{Visit national project partner (3 years x 1 visit x 2 researchers)}{500}{6}
\positionmul{Visit international project partners (3 years x 1 visit x 2 researchers)}{1000}{6}
\end{funds}

\subsubsubsection{Visiting Researchers}

As explained in Sections \ref{sec:collab:germany} and \ref{sec:collab:abroad}, we plan to cooperate with Prof. Dr. A Hajo Reijers (\todo{and some other random guys}). Costs of mutual visits are listed in above in Section \ref{sec:costs:travel}.
