...
\positionmul{Conference visits (3 x 2 x 2)}{1500}{12}
\positionmul{Project meetings (3 x 2)}{500}{6}
\position{Visit Utrecht University}{1500}{2}
\position{Visit \todo{other random place}}{1000}{2}
\end{funds}

\subsubsubsection{Visiting Researchers}

As explained in Sections \ref{sec:collab:germany} and \ref{sec:collab:abroad}, we plan to cooperate with Prof. Dr. A Hajo Reijers (\todo{and some other random guys}). Costs of mutal visits are listed in above in Section \ref{sec:costs:travel}.
