...
Although various process discovery algorithms have been developed, these are not tailored to the representation of abstracted, low-level events. Hence, they cannot provide users with an effective representation of the UI log.   The challenge, therefore, is to develop a technique that can achieve this by, among others, balancing between high-level and low-level information.
%
