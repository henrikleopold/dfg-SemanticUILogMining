...
The objective of this project is to develop approaches that address the six key challenges raised in Section \ref{sec:startingpoint}. As visualzied in \autoref{fig:approach}, the first three approaches will jointly allow us to go from a UI log into an event log, having done event annotation, noise removal, and case identification, while the latter three approaches will turn this event log into an appropriate process model, via abstraction, labeling, and visualization.
...
\subsubsection{Work package 1: UI log enrichment (6 PM)}
\label{sec:wp1}
...
\subsubsection{Work package 2:  Noise removal (13.5 PM)}
\label{sec:wp2}
...
\subsubsection{Work package 3: Case identification (16.5 PM)}
\label{sec:wp3}
...
\subsubsection{Work package 4: Log abstraction (12 PM)}
\label{sec:wp4}
...
\subsubsection{Work package 5: Activity labeling (12 PM)}
\label{sec:wp5}
...
\subsubsection{Work package 6: Visualization (12 PM)}
\label{sec:wp6}
