...
\geometry{
	hmargin=2.5cm, % Horizontal margin
...
\columnratio{0.50,0.45} % The relative ratios of the two columns in the CV
...
\hypersetup{colorlinks, breaklinks, urlcolor=linkcolor, linkcolor=linkcolor, linktocpage=true} % Set up links and their colours
...
\newcommand{\workposition}[5]{
	...
	\expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\large\textsc{#3}}\\} % Employer
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\normalsize{\textbf{#4}}}\\[4pt]} % Job title
